...
public class SecondController {
	...
	public String test1(Model model, @RequestParam("name") String name, @RequestParam("weight") double weight,
	...
	public String test2(Model model, @RequestParam("name") String name, @RequestParam("weight") double weight,
